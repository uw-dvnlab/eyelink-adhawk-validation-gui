...
#%
df_test = df_data.loc[df_data.subject=='AE03']
df_test['diff'] = np.abs(df_test.amp_el - df_test.amp_ah)
df_test = df_test.drop(df_test[df_test['corr'] < 0.1].index)
df_test = df_test.drop(df_test[df_test['t_start_el'] > 1.5].index)
#%
