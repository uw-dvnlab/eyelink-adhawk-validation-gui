...
nSac_EL = length(handles.trial_data(handles.trialNo).saccadesX_primary_EL) ...
    + length(handles.trial_data(handles.trialNo).saccadesY_primary_EL);
nSacM_EL = length(handles.trial_data(handles.trialNo).saccadesX_marked_EL) ...
    + length(handles.trial_data(handles.trialNo).saccadesY_marked_EL);
nSac_AH = length(handles.trial_data(handles.trialNo).saccadesX_primary_AH) ...
    + length(handles.trial_data(handles.trialNo).saccadesY_primary_AH);
nSacM_AH = length(handles.trial_data(handles.trialNo).saccadesX_marked_AH) ...
    + length(handles.trial_data(handles.trialNo).saccadesY_marked_AH);
...
[muR, muL, stdR, stdL] = computeFixationSTD(handles);
