...
if strcmp(handles.task, 'HMS')
    if get(handles.chk_el_sac,'Value')
        plotSac(handles.trial_data(trialNo).saccadesX_EL, ...
            handles.trial_data(trialNo).saccades_primary_EL, ...
            handles.trial_data(trialNo).saccades_marked_EL, ...
            pltX, handles, lim_lines)
    end
    % AdHawk
    if get(handles.chk_ah_sac,'Value')
        plotSac(handles.trial_data(trialNo).saccadesX_AH, ...
            handles.trial_data(trialNo).saccades_primary_AH, ...
            handles.trial_data(trialNo).saccades_marked_AH, ...
            pltX, handles, lim_lines)
    end
